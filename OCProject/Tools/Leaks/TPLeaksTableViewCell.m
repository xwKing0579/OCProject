//
//  TPLeaksTableViewCell.m
//  OCProject
//
//  Created by 王祥伟 on 2023/12/22.
//

#import "TPLeaksTableViewCell.h"
@interface TPLeaksTableViewCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UIView *lineView;
@property (nonatomic, strong) UIImageView *arrowImageView;
@end

@implementation TPLeaksTableViewCell

+ (instancetype)initWithTableView:(UITableView *)tableView withObject:(id)obj{
    TPLeaksTableViewCell *cell = [self initWithTableView:tableView];
