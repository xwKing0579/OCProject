//
//  TPMonitorDetailViewController.m
//  OCProject
//
//  Created by 王祥伟 on 2023/12/20.
//

#import "TPMonitorDetailViewController.h"

@interface TPMonitorDetailViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray *data;
@end

@implementation TPMonitorDetailViewController
