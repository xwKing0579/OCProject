...
@interface TPDebugSwitchViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [NSObject performTarget:@"TPDebugSwitchTableViewCell_Class" action:@"initWithTableView:withObject:" object:tableView object:self.data[indexPath.row]] ?: [UITableViewCell new];
}
